...
def sample_ppo_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    net_arch = trial.suggest_categorical("net_arch", ["small", "medium", "large", "deep_large", "deep_medium", "deep_small"])
    ...
    net_arch = {
        ...
        "large": [dict(pi=[512, 512, 256], vf=[512, 512, 256])],
        "deep_medium": [dict(pi=[256, 256, 64, 64], vf=[256, 256, 64, 64])],
        "deep_small": [dict(pi=[64, 64, 32, 32], vf=[64, 64, 32, 32])],
        "deep_large": [dict(pi=[512, 512, 256, 256, 64, 64], vf=[512, 512, 256, 256, 64, 64])],
    }[net_arch]
